      ...
      <form className="w-full relative">
        <label>
          <input
            ...
            readOnly={true}
            className="w-full h-12 px-4 py-2  rounded-lg border  border-neutral-300 dark:border-neutral-500  dark:bg-neutral-900 focus:outline-none dark:focus:border-neutral-700"
          />
          <div onClick={handleCopyUrl} className="absolute top-1/2 -translate-y-1/2 right-2 rounded-full px-4 py-1.5  cursor-pointer bg-blue-500">
            copy
          </div>
        </label>
      </form>
