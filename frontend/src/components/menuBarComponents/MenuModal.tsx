    ...
    >
      <div className="h-full py-5 px-4 grid grid-cols-1 auto-rows-min space-y-4 overflow-y-auto overflow-hidden scroll-smooth ">
        ...
        <section className={` flex flex-col space-y-3  border-b-[0.5px] pb-4`}>
          <MenuComponent customIconSrc={homeIconPath} isPath={visited} title="Home" link="/" isOffCanvas={true} onMouseEnter={mouseEnter} onMouseLeave={mouseLeave} />
          <MenuComponent title="Shorts" customIconSrc={shortsIconPath} isPath={visited} link="#" isOffCanvas={true} onMouseEnter={mouseEnter} onMouseLeave={mouseLeave} />
          <MenuComponent
            title="Subscriptions"
            isPath={visited}
          ...
          <>
            ...
            <section className={` flex flex-col space-y-3  border-b-[0.5px] pb-4`}>
              ...
              <MenuComponent
                ...
                onMouseLeave={mouseLeave}
              />
              <MenuComponent customIconSrc={historyIconPath} isPath={visited} title="History" link="#" isOffCanvas={true} onMouseEnter={mouseEnter} onMouseLeave={mouseLeave} />
              <MenuComponent customIconSrc={playListPath} isPath={visited} title="Playlist" link="#" isOffCanvas={true} onMouseEnter={mouseEnter} onMouseLeave={mouseLeave} />
              <MenuComponent customIconSrc={watchLaterPath} isPath={visited} title="Watch Later" link="#" isOffCanvas={true} onMouseEnter={mouseEnter} onMouseLeave={mouseLeave} />
              <MenuComponent
        ...
        <section className={` flex flex-col space-y-3  border-b-[0.5px] pb-4`}>
          ...
          <MenuComponent customIconSrc={trendingIconPath} isPath={visited} title="Trending" link="#" isOffCanvas={true} onMouseEnter={mouseEnter} onMouseLeave={mouseLeave} />
          <MenuComponent customIconSrc={shoppingIconPath} isPath={visited} title="Shopping" link="#" isOffCanvas={true} onMouseEnter={mouseEnter} onMouseLeave={mouseLeave} />
          <MenuComponent customIconSrc={musicIconPath} isPath={visited} title="Music" link="#" isOffCanvas={true} onMouseEnter={mouseEnter} onMouseLeave={mouseLeave} />
          <MenuComponent customIconSrc={moviesIconPath} isPath={visited} title="Movies" link="#" isOffCanvas={true} onMouseEnter={mouseEnter} onMouseLeave={mouseLeave} />
          <MenuComponent customIconSrc={liveIconPath} isPath={visited} title="Live" link="#" isOffCanvas={true} onMouseEnter={mouseEnter} onMouseLeave={mouseLeave} />
          <MenuComponent customIconSrc={gamingIconPath} isPath={visited} title="Gaming" link="#" isOffCanvas={true} onMouseEnter={mouseEnter} onMouseLeave={mouseLeave} />
          <MenuComponent customIconSrc={newsIconPath} isPath={visited} title="News" link="#" isOffCanvas={true} onMouseEnter={mouseEnter} onMouseLeave={mouseLeave} />
          <MenuComponent customIconSrc={sportsIconPath} isPath={visited} title="Sports" link="#" isOffCanvas={true} onMouseEnter={mouseEnter} onMouseLeave={mouseLeave} />
          <MenuComponent customIconSrc={coursesIconPath} isPath={visited} title="Courses" link="#" isOffCanvas={true} onMouseEnter={mouseEnter} onMouseLeave={mouseLeave} />
          <MenuComponent customIconSrc={fashionBeautyIconPath} isPath={visited} title="Fashion" link="#" isOffCanvas={true} onMouseEnter={mouseEnter} onMouseLeave={mouseLeave} />
          <MenuComponent customIconSrc={podcastIconPath} isPath={visited} title="Podcast" link="#" isOffCanvas={true} onMouseEnter={mouseEnter} onMouseLeave={mouseLeave} />
          <MenuComponent customIconSrc={playableIconPath} isPath={visited} title="Playables" link="#" isOffCanvas={true} onMouseEnter={mouseEnter} onMouseLeave={mouseLeave} />
        </section>
        {/* row-5 */}
        <section className={` flex flex-col space-y-3  border-b-[0.5px] pb-4`}>
          <MenuComponent customIconSrc={settingsIconPath} isPath={visited} title="Settings" link="#" isOffCanvas={true} onMouseEnter={mouseEnter} onMouseLeave={mouseLeave} />
          <MenuComponent customIconSrc={reportIconPath} isPath={visited} title="Report" link="#" isOffCanvas={true} onMouseEnter={mouseEnter} onMouseLeave={mouseLeave} />
          <MenuComponent customIconSrc={helpIconPatch} isPath={visited} title="Help" link="#" isOffCanvas={true} onMouseEnter={mouseEnter} onMouseLeave={mouseLeave} />
          <MenuComponent customIconSrc={sendFeedBackPath} isPath={visited} title="Feedback" link="#" isOffCanvas={true} onMouseEnter={mouseEnter} onMouseLeave={mouseLeave} />
        </section>
        {/* row-6 */}
