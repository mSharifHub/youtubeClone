...
export default function RecommendationsFilter({
  ...
  return (
    <div className="h-7  min-h-7  px-2 flex relative justify-center items-center rounded-lg transition-colors duration-200 ease-out bg-neutral-100 font-medium  capitalize hover:bg-neutral-200">
      <Link to={link}>
